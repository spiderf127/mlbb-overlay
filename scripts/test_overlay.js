...
function render() {
  ...
  if(S.teams?.blue?.logo) {
    bLogo.innerHTML=`<img src="teams/${S.teams.blue.logo}" class="team-logo" onerror="this.innerHTML='<div class=\\'team-logo-fallback\\'>B</div>'">`;
  } else { bLogo.innerHTML=`<div class='team-logo-fallback'>B</div>`; }
  
  if(S.teams?.red?.logo) {
    rLogo.innerHTML=`<img src="teams/${S.teams.red.logo}" class="team-logo" onerror="this.innerHTML='<div class=\\'team-logo-fallback\\'>R</div>'">`;
